# Contributor Name(s): Asa Henry, Zachary Hallemeyer
# Contributor Email(s): ajh728@nau.edu, zmh47@nau.edu
# This file encrypts and decrypts messages using the 'playfair cipher'
# The program takes a key and a message from the user and either
# decrypts or encrypts based on user input
...
def make_new_matrix(matrix, index_1, index_2, classifier):
    ...
    y_range = (range(index_1[0], index_2[0]+1) if index_1[0] < index_2[0] else range(index_2[0], index_1[0]+1))
